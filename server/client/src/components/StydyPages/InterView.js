...
<> 
    ...
    <div className="row d-flex justify-content-center mx-auto mt-4 mb-3"> 
       <div className='col-12  col-md-11 '>
        <h2 className='my-2 mb-2 Main_heading'>Most Common Interview Questions and Answers<span className='Hand'>&#128077;</span></h2>
              ...
              interView_latest.map((curelem)=>{              
                return (
                     <div className='col-11 col-md-6'>
                         <h5 className='my-4 Matrial' key={curelem.id}>👉 <a href={curelem.url} target="_newtab">{curelem.name}</a></h5>
