...
const Study = () => {
  ...
  const study_matrials = [
    ...
    },
    {
      ...
      img: DSABanner,
      url: `/study/Dsa`,
      des: "Complete list of Data Structure, Practice Problems, Quizzes,Linked List, Stack, Queue and more.."
    },
    {
      id: 3,
    ...
    },
    {
      ...
      des: "The JavaScript language. Here you learn JavaScript, starting from Zero To Hero."
